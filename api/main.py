...
# ---------------------------------------------------------------
NODES = {
    # Corridor 1 — Gangapur to Nandur Naka
    "Gangapur":           {"lat": 20.0219, "lng": 73.7677},
    "Jalapur":            {"lat": 20.0180, "lng": 73.7580},
    "Ganpat Nagar":       {"lat": 20.0140, "lng": 73.7500},
    "Kale Nagar":         {"lat": 20.0100, "lng": 73.7455},
    "Jehan Circle":       {"lat": 20.0060, "lng": 73.7520},
    "Thatte Nagar":       {"lat": 20.0040, "lng": 73.7600},
    "Panchavati":         {"lat": 20.0080, "lng": 73.7700},
    "Shivaji Nagar":      {"lat": 20.0020, "lng": 73.7830},
    "CBS":                {"lat": 20.0059, "lng": 73.7898},
    "Sharda Circle":      {"lat": 19.9980, "lng": 73.7960},
    "Dwarka Circle":      {"lat": 19.9940, "lng": 73.8100},
    "Gayatri Nagar":      {"lat": 19.9880, "lng": 73.8250},
    "Nandur Naka":        {"lat": 19.9900, "lng": 73.8442},
    # Corridor 2 — Western branch
    "Dhruv Nagar":        {"lat": 20.0280, "lng": 73.7400},
    "Shramik Nagar":      {"lat": 20.0150, "lng": 73.7100},
    "Mahindra":           {"lat": 20.0000, "lng": 73.7100},
    "Shaneshwar Nagar":   {"lat": 19.9868, "lng": 73.7170},
    "Satpur Colony":      {"lat": 19.9750, "lng": 73.7100},
    # Corridor 2 — Southern arc
    "MIDC":               {"lat": 19.9850, "lng": 73.7250},
    "ABB Circle":         {"lat": 19.9900, "lng": 73.7350},
    "Parijat Nagar":      {"lat": 19.9920, "lng": 73.7520},
    "MICO Circle":        {"lat": 19.9940, "lng": 73.7700},
    "Mumbai Naka":        {"lat": 19.9900, "lng": 73.7850},
    "Garware":            {"lat": 19.9500, "lng": 73.7350},
    # Feeder route
    "Samta Nagar":        {"lat": 19.9830, "lng": 73.8200},
    "Gandhi Nagar":       {"lat": 19.9750, "lng": 73.8100},
    "Nehru Nagar":        {"lat": 19.9650, "lng": 73.8050},
    "Datta Mandir":       {"lat": 19.9580, "lng": 73.8150},
    "Nashik Road Rly Stn":{"lat": 19.9500, "lng": 73.8280},
    # Additional retained nodes
    "College Road":       {"lat": 20.0110, "lng": 73.7800},
    "Nashik Phata":       {"lat": 20.0400, "lng": 73.7750},
    "Deolali":            {"lat": 19.9400, "lng": 73.8350},
}

EDGES = [
    # Corridor 1 — Gangapur to Nandur Naka (11 edges)
    ("Gangapur",        "Jalapur",          {"road_name": "Gangapur Link Road",    "segment_id": 1,  "base_travel_time": 10, "geometry": [], "landmarks": []}),
    ("Jalapur",         "Ganpat Nagar",     {"road_name": "Jalapur Road",          "segment_id": 2,  "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Ganpat Nagar",    "Kale Nagar",       {"road_name": "Anandvalli Road",       "segment_id": 3,  "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Kale Nagar",      "Jehan Circle",     {"road_name": "Gangapur Road",         "segment_id": 4,  "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Jehan Circle",    "Thatte Nagar",     {"road_name": "Gangapur Road Extension","segment_id": 5,  "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Thatte Nagar",    "Panchavati",       {"road_name": "Trimbak Road",          "segment_id": 6,  "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Panchavati",      "CBS",              {"road_name": "Panchavati Road",       "segment_id": 7,  "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("CBS",             "Sharda Circle",    {"road_name": "Nashik-Pune Road",      "segment_id": 8,  "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Sharda Circle",   "Dwarka Circle",    {"road_name": "Dwarka Road",           "segment_id": 9,  "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Dwarka Circle",   "Gayatri Nagar",    {"road_name": "Eastern Bypass",        "segment_id": 10, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Gayatri Nagar",   "Nandur Naka",      {"road_name": "Nandur Road",           "segment_id": 11, "base_travel_time": 10, "geometry": [], "landmarks": []}),
    # Corridor 2 — Western branch (5 edges)
    ("Gangapur",        "Dhruv Nagar",      {"road_name": "Satpur Link Road",      "segment_id": 12, "base_travel_time": 9,  "geometry": [], "landmarks": []}),
    ("Dhruv Nagar",     "Shramik Nagar",    {"road_name": "Dhruv-Shramik Road",    "segment_id": 13, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Shramik Nagar",   "Mahindra",         {"road_name": "Mahindra Road",         "segment_id": 14, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Mahindra",        "Shaneshwar Nagar", {"road_name": "MIDC Link Road",        "segment_id": 15, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Shaneshwar Nagar","Satpur Colony",    {"road_name": "Satpur Road",           "segment_id": 16, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    # Corridor 2 — Southern arc (7 edges)
    ("Satpur Colony",   "MIDC",             {"road_name": "MIDC Road",             "segment_id": 17, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("MIDC",            "ABB Circle",       {"road_name": "Industrial Road",       "segment_id": 18, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("ABB Circle",      "Parijat Nagar",    {"road_name": "ABB-Parijat Road",      "segment_id": 19, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Parijat Nagar",   "MICO Circle",      {"road_name": "Parijat Road",          "segment_id": 20, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("MICO Circle",     "Mumbai Naka",      {"road_name": "Mumbai Naka Road",      "segment_id": 21, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Mumbai Naka",     "CBS",              {"road_name": "Old Pune Road",         "segment_id": 22, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Satpur Colony",   "Garware",          {"road_name": "Garware Road",          "segment_id": 23, "base_travel_time": 12, "geometry": [], "landmarks": []}),
    # Feeder route (5 edges)
    ("Dwarka Circle",   "Samta Nagar",      {"road_name": "Samta Nagar Road",      "segment_id": 24, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Samta Nagar",     "Gandhi Nagar",     {"road_name": "Gandhi Nagar Road",     "segment_id": 25, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Gandhi Nagar",    "Nehru Nagar",      {"road_name": "Nehru Road",            "segment_id": 26, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Nehru Nagar",     "Datta Mandir",     {"road_name": "Datta Road",            "segment_id": 27, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Datta Mandir",    "Nashik Road Rly Stn",{"road_name": "Station Road",         "segment_id": 28, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    # Cross-links (22 edges)
    ("CBS",             "College Road",     {"road_name": "MG Road",               "segment_id": 29, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("College Road",    "Gangapur",         {"road_name": "College-Gangapur Road", "segment_id": 30, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("CBS",             "Shivaji Nagar",    {"road_name": "CBS Main Road",         "segment_id": 31, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Shivaji Nagar",   "MICO Circle",      {"road_name": "Shivaji-MICO Road",     "segment_id": 32, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Shivaji Nagar",   "Sharda Circle",    {"road_name": "Shivaji-Sharda Road",   "segment_id": 33, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("College Road",    "Panchavati",       {"road_name": "Sharanpur Road",        "segment_id": 34, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("College Road",    "Nashik Phata",     {"road_name": "Nashik Phata Road",     "segment_id": 35, "base_travel_time": 10, "geometry": [], "landmarks": []}),
    ("Gangapur",        "Nashik Phata",     {"road_name": "Gangapur-Phata Road",   "segment_id": 36, "base_travel_time": 12, "geometry": [], "landmarks": []}),
    ("Nashik Road Rly Stn","Deolali",       {"road_name": "Deolali Road",          "segment_id": 37, "base_travel_time": 12, "geometry": [], "landmarks": []}),
    ("Mumbai Naka",     "Sharda Circle",    {"road_name": "Mumbai-Sharda Road",    "segment_id": 38, "base_travel_time": 5,  "geometry": [], "landmarks": []}),
    ("Dwarka Circle",   "Parijat Nagar",    {"road_name": "Dwarka-Parijat Road",   "segment_id": 39, "base_travel_time": 9,  "geometry": [], "landmarks": []}),
    ("MIDC",            "Garware",          {"road_name": "Ambad Link Road",       "segment_id": 40, "base_travel_time": 10, "geometry": [], "landmarks": []}),
    ("Shaneshwar Nagar","MIDC",             {"road_name": "Shaneshwar-MIDC Road",  "segment_id": 41, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Kale Nagar",      "ABB Circle",       {"road_name": "Kale-ABB Road",         "segment_id": 42, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Jehan Circle",    "Parijat Nagar",    {"road_name": "Jehan-Parijat Road",    "segment_id": 43, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Gayatri Nagar",   "Samta Nagar",      {"road_name": "Gayatri-Samta Road",    "segment_id": 44, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("Nandur Naka",     "Nashik Road Rly Stn",{"road_name": "Nandur-Station Road",  "segment_id": 45, "base_travel_time": 11, "geometry": [], "landmarks": []}),
    ("Mumbai Naka",     "Gandhi Nagar",     {"road_name": "Mumbai-Gandhi Road",    "segment_id": 46, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Shramik Nagar",   "Shaneshwar Nagar", {"road_name": "Western Bypass",        "segment_id": 47, "base_travel_time": 7,  "geometry": [], "landmarks": []}),
    ("College Road",    "Shivaji Nagar",    {"road_name": "College-Shivaji Road",  "segment_id": 48, "base_travel_time": 6,  "geometry": [], "landmarks": []}),
    ("Dwarka Circle",   "Mumbai Naka",      {"road_name": "Dwarka-Mumbai Road",    "segment_id": 49, "base_travel_time": 8,  "geometry": [], "landmarks": []}),
    ("Deolali",         "Samta Nagar",      {"road_name": "Deolali-Samta Road",    "segment_id": 50, "base_travel_time": 9,  "geometry": [], "landmarks": []}),
]
